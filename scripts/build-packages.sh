...
DEBIAN_DISTRIBUTION="${MSICONTROLLER_PACKAGE_DEBIAN_DISTRIBUTION:-stable}"
DEBIAN_COMPONENT="${MSICONTROLLER_PACKAGE_DEBIAN_COMPONENT:-main}"
...
cmake -S "${PROJECT_ROOT}" -B "${BUILD_DIR}" -G Ninja \
  ...
  -DMSICONTROLLER_PACKAGE_REPOSITORY_ENABLE="${REPOSITORY_ENABLE}" \
  -DMSICONTROLLER_PACKAGE_REPOSITORY_BASE_URL="${REPOSITORY_BASE_URL}" \
  -DMSICONTROLLER_PACKAGE_REPOSITORY_OWNER="${REPOSITORY_OWNER}" \
  -DMSICONTROLLER_PACKAGE_DEBIAN_DISTRIBUTION="${DEBIAN_DISTRIBUTION}" \
  -DMSICONTROLLER_PACKAGE_DEBIAN_COMPONENT="${DEBIAN_COMPONENT}" \
  -DMSICONTROLLER_PACKAGE_RPM_GROUP="${RPM_GROUP}"
